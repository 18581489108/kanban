...
//loadlive2d("live2d", "./assets/hiyori/hiyori.model3.json");

var pixiKoharu;
(function (pixiKoharu) {
    PIXI.loader
        .add('moc', "../assets/hiyori/hiyori.moc3", { xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.BUFFER })
        .add('texture', "../assets/hiyori/hiyori.2048/texture_00.png")
        .add('motion', "../assets/hiyori/motions/hiyori_m01.motion3.json", { xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.JSON })
